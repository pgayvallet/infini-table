...
// sorting : string | numeric | date

define("taelys.common", function(module) {

    module.controller("InfiniTableController", function($scope, $element,
                                                        $parse, $compile, $interpolate, $rootScope, $window,
                                                        itDefaultConfig, itSortFactory, scopeUtils) {
        ...
        var initializeRowSelection = function() {
            ...
            var selectionAccessor = scopeUtils.createAccessor(selectionScope, config.selectionAttribute);
        ...
        var rowManagementCycle = function() {
            ...
            if(rowPrecompilationQueue.length) {
                ...
                var watcherCount = scopeUtils.countWatchers(config.countRootWatchers ? $rootScope : $scope);
    ...
    module.directive('infiniTable', function (keyCodes, itTableRegistry) {
        return {
            restrict : "E",
            replace  : true,
            scope    : true,
     ...
     * it-header-cell
     */
    module.directive('itHeaderCell', function () {
        return {
            restrict : "A",
            require : "^infiniTable",
            scope : true,
     ...
     * IT Body Row
     */
    module.directive('itRow', function ($compile, $interpolate, scopeUtils) {
        return {
            restrict : "A",
            require : "^infiniTable",
            scope : true,
            link : function($scope, $el, $attrs, tableCtrl) {
                ...
                var constructRow = function() {
                    ...
                    scopeUtils.applyWatchers($scope);
                };
     ...
     * IT Scrollbar
     */
    module.directive('itScrollBar', function ($window) {
        return {
            restrict : "EA",
            scope : true,
